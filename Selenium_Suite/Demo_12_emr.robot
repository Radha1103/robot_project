...
TC1
    ...
    Input Password    id=clearPass    pass
     ...
     Select From List By Label    xpath=//select[@class='form-control']     English (Indian)
      ...
      Input Text    xpath=//input[@id='form_fname']    radhika
      Input Text    xpath=//input[@id='form_lname']    kavishwar
      ...
      ${alert_text}  Handle Alert    action=ACCEPT    timeout=30s
       ...
       Element Should Contain    xpath=//span[text()='radhika kavishwar']       radhika kavishwar
       Sleep    5s
       Close Browser
